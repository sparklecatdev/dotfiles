 ...
 ***/
 ...
 /*******************************************************************************
  * Vega's Arkenfox daily-driver overrides
  *
  * Put this file beside user.js in your Firefox profile and name it:
  *   user-overrides.js
  *
  * These overrides preserve Arkenfox's core privacy protections while restoring
  * normal day-to-day conveniences such as sessions, logins, form fill, caching,
  * downloads, geolocation prompts, and public Wi-Fi login pages.
  ******************************************************************************/

 /*** STARTUP AND TABS ***/
 // Restore the previous browsing session after a normal restart.
 user_pref("browser.startup.page", 3);

 // Use Firefox Home for new windows and tabs. Sponsored items remain disabled by user.js.
 user_pref("browser.startup.homepage", "about:home");
 user_pref("browser.newtabpage.enabled", true);

 /*** SEARCH AND FORMS ***/
 // Restore search suggestions and form autocomplete.
 // Search queries typed in the address bar may be sent to your chosen search engine.
 user_pref("browser.search.suggest.enabled", true);
 user_pref("browser.urlbar.suggest.searches", true);
 user_pref("browser.formfill.enable", true);

 // Allow Firefox's password manager to fill and capture logins.
 // Remove these two lines if you exclusively use Bitwarden/another extension.
 user_pref("signon.autofillForms", true);
 user_pref("signon.formlessCapture.enabled", true);

 /*** PERFORMANCE AND SESSION RELIABILITY ***/
 // Re-enable the normal disk cache for faster repeat visits and less re-downloading.
 user_pref("browser.cache.disk.enable", true);

 // Preserve normal session data needed for restoring forms and tabs.
 user_pref("browser.sessionstore.privacy_level", 0);

 // Allow Firefox to restore itself after an OS reboot on Windows.
 user_pref("toolkit.winRegisterApplicationRestart", true);

 /*** DOWNLOADS ***/
 // Save downloads to the configured Downloads folder instead of prompting every time.
 user_pref("browser.download.useDownloadDir", true);

 // Use remembered handlers for known file types rather than asking every time.
 user_pref("browser.download.always_ask_before_handling_new_types", false);

 // Open the downloads panel when a download begins.
 user_pref("browser.download.alwaysOpenPanel", true);

 // Keep downloaded/opened files in their normal location instead of forcing temp storage.
 user_pref("browser.download.start_downloads_in_tmp_dir", false);

 // Show downloaded files in the operating system's recent-files list.
 user_pref("browser.download.manager.addToRecentDocs", true);

 /*** COOKIES, LOGINS, AND SITE DATA ***/
 // Do not erase cookies, site storage, cache, or form data whenever Firefox closes.
 // Strict ETP and Total Cookie Protection remain enabled by the base user.js.
 ...
 /*** NETWORK USABILITY ***/
 // Detect hotel, school, airport, and café Wi-Fi sign-in pages.
 ...
 // Permit the operating system's location service. Sites must still ask permission.
 ...
 // Restore Firefox's privacy-preserving remote download reputation check.
 // Malware/phishing Safe Browsing remains enabled either way.
 user_pref("browser.safebrowsing.downloads.remote.enabled", true);

 /*** OPTIONAL CONVENIENCE SWITCHES ***/
 // Uncomment to let links pre-load for slightly snappier browsing at a privacy cost.
 ...
 // End marker for quick verification in about:config.
 user_pref("_user.js.daily_overrides", "loaded");
